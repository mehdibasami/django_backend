...
# from ..fitness.models.workout import Exercise, WorkoutSession, WorkoutProgram, ProgramAssignment
...
#     NotFoundResponse,
# )
# from config.utils.custom_serializers import create_response_serializer, create_paginated_response_serializer
# from apps.account.permissions import IsActiveUserPermission, CanAssignWorkoutProgram
...
#             # Assign new
#             assignment, created = ProgramAssignment.objects.update_or_create(
#                 user=user,
#                 program=program,
#             )
...
#     def get(self, request):
#         try:
#             queryset = ProgramAssignment.objects.filter(user=request.user)
#             paginator = self.pagination_class()
